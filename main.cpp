 ...
 * Author:    P.Dagorret ()
 * Created:   2021-05-10
 * Description : Programme TEST de la classe metier Chifoumi-v1
 **************************************************************/
...
///* ------  Specifications des Sous-pogrammes utilitaires ------------

Chifoumi::UnCoup genererCoup();
/* duplique la methode privee de la classe Chifoumi,
...
// affiche les valeurs actuellement stockees dans les attributs coupJoeur et coupMachine

string coup2String(Chifoumi::UnCoup p_coup);
/* retourne une chaine correspondant a la valeur de p_coup, cad :
...
int main()
{
    ...
    char rep ;      // reponse a demande de Quitter
    ...
    cout << "teste les methodes set() et get() associees aux attributs 'coup'/'choix' " << endl;
    ...
    // le testeur peut iterer autant de fois qu'il/elle veut
    while (true)
    {
        monJeu.setCoupJoueur(Chifoumi::pierre);
...
///* ------  Definitions des sous-pogrammes utilitaires ------------

Chifoumi::UnCoup genererCoup()
{
    Chifoumi::UnCoup valeurGeneree;   // valeur a retourner
